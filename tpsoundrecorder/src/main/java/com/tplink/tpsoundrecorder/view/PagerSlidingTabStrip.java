...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    /** The tab text color. */
    private int tabTextColor = 0x9FFFFFFF;

    /** The selected position. */
    private int selectedPosition = 0;

    /** The selected tab text color. */
     ...
     * Sets the view pager.
     *
     * @param pager the new view pager
     */
     ...
     * component's <code>addPageListener<code> method. When the page event
    ...
    /**
     * Sets the selected text color resource.
     *
     * @param resId the new selected text color resource
     */
     ...
     *
     * @param indicatorColor the new indicator color
     */
     ...
     *
     * @param resId the new indicator color resource
     */
     ...
     *
     * @param indicatorLineHeightPx the new indicator height
     */
     ...
     *
     * @param underlineColor the new underline color
     */
     ...
     *
     * @param resId the new underline color resource
     */
     ...
     *
     * @param dividerColor the new divider color
     */
     ...
     *
     * @param resId the new divider color resource
     */
     ...
     *
     * @param underlineHeightPx the new underline height
     */
     ...
     *
     * @param dividerPaddingPx the new divider padding
     */
     ...
     *
     * @param scrollOffsetPx the new scroll offset
     */
     ...
     *
     * @param shouldExpand the new should expand
     */
     ...
     * Sets the all caps.
     *
     * @param textAllCaps the new all caps
     */
     ...
     * Sets the text size.
     *
     * @param textSizePx the new text size
     */
     ...
     *
     * @param resId the new text color resource
     */
    public void setTextColorResource(int resId) {
        this.tabTextColor = ContextCompat.getColor(getContext(), resId);// getResources().getColor(resId);
        updateTabStyles();
    }
     ...
     *
     * @param resId the new tab background
     */
     ...
     *
     * @param paddingPx the new tab padding left right
     */
    ...
    static class SavedState extends BaseSavedState {
         ...
         * (non-Javadoc)
         * @see
         * android.view.View.BaseSavedState#writeToParcel(android.os.Parcel,
         * int)
         */
        @Override
